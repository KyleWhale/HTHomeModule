...
@implementation HTHomeWaterfallManager
...
+ (UILabel *)lgjeropj_titleLabel {
    ...
    return [HTKitCreate ht_labelWithText:@"" andFont:[UIFont systemFontOfSize:12 weight:UIFontWeightRegular] andTextColor:[UIColor colorWithHexString:@"#CCCCCC"] andAligment:NSTextAlignmentLeft andNumberOfLines:2];
}
